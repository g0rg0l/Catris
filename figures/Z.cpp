...
Z::Z(sf::Vector2f pos)
{
    ...
    Square part2(sf::Vector2f(figurePosition.x + figurePartsSize, figurePosition.y),
                 figurePartsSize, figureColor, 2);
    Square part3(sf::Vector2f(figurePosition.x + figurePartsSize, figurePosition.y + figurePartsSize),
                 figurePartsSize, figureColor, 2);
    Square part4(sf::Vector2f(figurePosition.x + 2*figurePartsSize, figurePosition.y + figurePartsSize),
                 figurePartsSize, figureColor, 2);
